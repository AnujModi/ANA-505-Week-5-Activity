...
View(WorldCup)    #i can also use head here... which i have done below:
head(WorldCup)
WorldCup
...
worldCupSample<-sample(WorldCup, size=15, replace = FALSE)

#TASK: Save the new sample as a csv file
write.csv(worldCupSample, file = "worldCupSample.csv", row.names = FALSE)
...
#commenting the below code here...
#mysample2<-mysample
